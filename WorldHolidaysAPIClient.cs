...
namespace APIVerve
{
    public class WorldHolidaysAPIClient
    {
        ...
        public WorldHolidaysAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public WorldHolidaysAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(worldholidaysQueryOptions options)
        {
            try
            {
                if (_isDebug)
